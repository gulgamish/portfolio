...
import FillerThumbnail from "../../src/assets/filler.gif";
        ...
        <SimpleGrid gap={6} columns={[1, 1, 2]}>
          <Section delay={0.4}>
            <GridItem title="O-Talent" href="" thumbnail={otalentThumbnail}>
              The goal of the project is the Digitalization of the OCP Human
              Resources Management and it consisted of multiple Modules
            </GridItem>
          </Section>
          <Section delay={0.4}>
        ...
        <SimpleGrid gap={6} columns={[1, 1, 2]}>
          <Section delay={0.4}>
            <GridItem
              ...
              thumbnail={corewarThumbNail}
            >
              Re-Programing of Core War, it's a 1984 programming game created by
              D. G. Jones and A. K. Dewdney in which two or more battle programs
              (called "warriors") compete for control of a virtual computer.
              These battle programs are written in an abstract assembly language
              called Redcode
            </GridItem>
          </Section>
          <Section delay={0.4}>
          ...
          <Section delay={0.5}>
            <GridItem
              title="Filler"
              type="Algorithm"
              thumbnail={FillerThumbnail}
            >
              This project is about crafting an intelligent program that fill
              the maximum number of cases before the other program
            </GridItem>
          </Section>
        </SimpleGrid>
      </Container>
